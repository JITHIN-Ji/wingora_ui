...
export default function SubscribeNewsletter() {
    return (
        <section className="flex flex-col items-center">
            <SectionTitle title="Stay Updated with AI Insights" description="Get the latest updates on AI automation, business growth strategies, and exclusive tips delivered to your inbox." />
        ...
        >
                <input type="email" className="bg-transparent outline-none rounded-full px-4 h-full flex-1 placeholder:text-slate-400" placeholder="Enter your email address" />
